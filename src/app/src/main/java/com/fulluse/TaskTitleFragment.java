...
public class TaskTitleFragment extends Fragment {

    private RelativeLayout rootLayout;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_task_name, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        try {
            ...
            tfi.onTitleFragmentCreated(rootLayout);
